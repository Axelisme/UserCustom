...
or pointer; `COMPLETED` is the binary attestation that every required Mechanical gate passed and
every writer-owned Acceptance claim was re-verified against the final tree.
