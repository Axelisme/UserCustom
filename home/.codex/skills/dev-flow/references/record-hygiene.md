...
- The filesystem under `artifacts/` is the artifact inventory. A separate list beside it drifts.
  `locate` does not enumerate the record: it reports the frontier and what to read
