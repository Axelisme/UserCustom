...
def added_paths(root: Path, base: str, subject: str) -> list[str]:
    """Return tracked paths added by the final tree-to-tree diff."""
    return changed_paths(root, "--diff-filter=A", base, subject)
