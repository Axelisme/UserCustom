...
Root follows the shared dev-flow S5/S6 scheduling and machine-rework contract; this runtime
binding adds no mode or acceptance authority. At the required final gate, dispatch one fresh
