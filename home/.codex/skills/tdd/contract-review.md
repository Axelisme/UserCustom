...
promises have a fixed red test surface, the caller may request a read-only Contract reviewer before
...
a caller judgement about risk, never test line count, commit count, correction count, or a
