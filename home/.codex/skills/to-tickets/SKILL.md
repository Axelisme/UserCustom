...
Work the frontier one ticket at a time, clearing context between tickets — in a plan-directory repo, Root dispatches the ready Slice role flow; elsewhere, use one fresh session per ticket.
