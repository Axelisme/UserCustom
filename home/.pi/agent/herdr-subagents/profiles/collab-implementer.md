...
with the question still unanswered. When you need an Orchestrator decision, ask with `contact_parent`
(`kind: "decision"`) and stay live for the answer; it arrives as that tool's result and you continue
