...
class CoreContractTests(unittest.TestCase):
    """Black-box Root contract for the Git-only core tracer.
    ...
    def create_worktree(self, root: Path, role: str) -> dict[str, Any]:
        result = self.cli(
            root,
    ...
    def test_help_exposes_only_the_workflow_and_administration(self) -> None:
